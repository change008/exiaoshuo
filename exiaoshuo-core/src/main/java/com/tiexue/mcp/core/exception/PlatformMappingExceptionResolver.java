package com.tiexue.mcp.core.exception;
...
public class PlatformMappingExceptionResolver extends SimpleMappingExceptionResolver {
	...
	private Logger logger = Logger.getLogger(PlatformMappingExceptionResolver.class);
		...
		if (viewName != null) {
			if (!(request.getHeader("accept").indexOf("application/json") > -1
				...
				try {
					...
					response.setStatus(501, ExceptionI18Message.getLocaleMessage(ex.getMessage()));
