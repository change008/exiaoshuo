...
public class WxConstants {
	// 微信验证 token
	public static final String WxToken = "txmobilekey"; //ok

	// 微信网页授权state
	public static final String WxOauthState = "ok"; //ok

	// 微信公众号Appid
	public static final String WxAppId = "wxc81e9472a78d0785"; //ok
	...
	// 微信商户支付相关
	public static final String WxMch_Id = "1489679572"; //ok
	...
	// 交易发起方式
	public static final String WxMch_TradeType = "JSAPI";  //ok
